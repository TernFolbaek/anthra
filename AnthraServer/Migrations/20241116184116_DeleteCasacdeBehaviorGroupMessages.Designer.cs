...
namespace AnthraBackend.Migrations
{
    ...
    [Migration("20241116184116_DeleteCasacdeBehaviorGroupMessages")]
    partial class DeleteCasacdeBehaviorGroupMessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyBackendApp.Models.Attachment", b =>
                {
                    ...
                    b.Property<int?>("GroupMessageId1")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyBackendApp.Models.Attachment", b =>
                {
                    ...
                    b.HasOne("MyBackendApp.Models.GroupMessage", null)
                        .WithOne("Attachment")
                        .HasForeignKey("MyBackendApp.Models.Attachment", "GroupMessageId1");
                    ...
                    b.HasOne("MyBackendApp.Models.Message", null)
                        .WithOne("Attachment")
                        .HasForeignKey("MyBackendApp.Models.Attachment", "MessageId1");
